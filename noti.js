const localUsername = localStorage.getItem('crazy_local');

async function fetchUserData(username) {
    try {
        const response = await fetch('https://script.google.com/macros/s/AKfycbzfIAiDlc8QQBnOIZxQu1x86cH4y-6jd7PMX8fHcffM2xAQUHsjKr5V__j8FEUsRLfZ/exec?username=' + username);
