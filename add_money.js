const username = localStorage.getItem('crazy_local');
if (!username) {
    alert('Please Login First!');
}

const SCRIPT_URL = 'https://script.google.com/macros/s/AKfycby58PytDD8o7WqlKX97oOaVeyH0VcboPQomUo6DcsAQO2mLo4wqGKeaN6_wgTKDEA_s/exec';
...
async function uploadToImgur(file) {
    ...
    const response = await fetch('https://api.imgur.com/3/image', {
        method: 'POST',
        headers: {
            'Authorization': 'Client-ID 7549f0036f22644'
        },
        body: formData
    });
