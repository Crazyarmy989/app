function getUsernameFromLocalStorage() {
  return localStorage.getItem('crazy_local');
}
...
function fetchUserCoins(username) {
  ...
  const url = 'https://script.google.com/macros/s/AKfycbyPgD92AwpuQX5yQwUGFf4B3HtKjILI7iMXj6WdRxFx0-OVEP12D6nGwr6gdZgXeOB3/exec';
